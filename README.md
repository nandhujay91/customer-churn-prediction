...
This project trains and compares two classifiers (Logistic Regression and XGBoost) on the IBM Telco Customer Churn dataset, then selects a decision threshold that minimizes total business cost ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â not just a generic metric like accuracy or F1. The result: a model whose predictions are tuned to how expensive it actually is to lose a customer vs. wasting a retention offer on someone who was never going to leave.
...
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡ ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ raw/ # original Kaggle CSV
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡ ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬ÂÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ processed/ # cleaned data, train/test splits, scaler
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ models/ # trained model + comparison metrics
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ src/
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡ ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ data/make_dataset.py # load + clean raw data
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡ ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ features/build_features.py # encode, scale, split
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡ ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬ÂÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ models/
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡ ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ train_model.py # train + cost-optimal threshold tuning
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡ ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬ÂÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ predict_model.py # inference on new customers
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ tests/ # unit tests for data + feature logic
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ .github/workflows/ # CI: lint + test on every push
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Dockerfile # containerized pipeline (Chainguard base)
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬ÂÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ configs/base.yaml # pipeline configuration
## Setup
...
`--cost-fn` and `--cost-fp` let you adjust the assumed dollar cost of a missed churner vs. a wasted retention offer ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â the threshold is re-optimized accordingly.
...
4. **Threshold selection:** rather than using the default 0.5 cutoff, search thresholds and pick the one that **minimizes total expected cost** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â `(false negatives ÃƒÆ’Ã¢â‚¬â€ cost of losing a customer) + (false positives ÃƒÆ’Ã¢â‚¬â€ cost of a wasted offer)`.
...
Logistic Regression outperforms XGBoost on this dataset ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â a legitimate and common outcome given the dataset's relatively small size and largely linear relationships between features (tenure, contract type) and churn.

Lowering the decision threshold to the cost-optimal value trades precision for a large recall gain, catching 91% of real churners instead of 57% ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â a deliberate choice justified by the assumption that losing a customer is roughly 5x more costly than a wasted retention offer.

## Known Limitations

- Precision drops meaningfully at cost-optimal thresholds ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â in practice, this means many "at risk" flags will be false alarms, which is only acceptable if the retention intervention itself is low-cost (e.g. an automated email, not a phone call).
...
- No monitoring for model drift over time ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â performance should be re-validated periodically as customer behavior changes.
...
`mlflow.db` (tracking database) is excluded from git â€” it's local experiment history, not part of the codebase.
